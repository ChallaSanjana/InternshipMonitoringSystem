        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                min={internshipStartDate ? internshipStartDate.slice(0, 10) : undefined}
                max={internshipEndDate ? internshipEndDate.slice(0, 10) : undefined}
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              {internshipStartDate && internshipEndDate && (
                <p className="mt-1 text-xs text-gray-500">
                  Allowed range: {new Date(internshipStartDate).toLocaleDateString()} - {new Date(internshipEndDate).toLocaleDateString()}
                </p>
              )}
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Example: Implemented internship dashboard filters, fixed file upload validation, and tested API responses for report submission."
            />
          </div>
