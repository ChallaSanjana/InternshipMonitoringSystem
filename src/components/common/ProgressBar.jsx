export default function ProgressBar({ progress, showPercentage = true, size = 'small' }) {
    ...
    return (<div className="flex items-center gap-2">
      <div className={`flex-1 w-32 overflow-hidden rounded-full bg-slate-200 ${heightClass}`}>
        <div className="h-full bg-emerald-500 transition-all duration-300" style={{ width: `${clampedProgress}%` }}/>
      </div>
