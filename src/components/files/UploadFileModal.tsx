...
export default function UploadFileModal({ internshipId, onClose, onSuccess }: UploadFileModalProps) {
  const [fileType, setFileType] = useState<'offer_letter' | 'report' | 'certificate'>('offer_letter');
      ...
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-5">
          ...
          <div>
            ...
            <select
              value={fileType}
              onChange={(e) => setFileType(e.target.value as 'offer_letter' | 'report' | 'certificate')}
