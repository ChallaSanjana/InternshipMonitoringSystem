...
export default function RoleSelectionPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
          ...
          {roleOptions.map((role) => {
            ...
            return (
              <button
                ...
                className={`group rounded-xl bg-gradient-to-br ${role.styles} p-6 text-left text-white shadow-lg transition duration-200 hover:-translate-y-1`}
              >
