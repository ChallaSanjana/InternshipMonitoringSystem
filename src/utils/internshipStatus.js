export function getDateBasedStatus(startDate, endDate) {
    const now = new Date();
...
export function getInternshipTimeStatus(startDate, endDate) {
    const now = new Date();
    const current = new Date(now.getFullYear(), now.getMonth(), now.getDate()).getTime();
    const start = new Date(startDate);
    const startTime = new Date(start.getFullYear(), start.getMonth(), start.getDate()).getTime();
...
export function getInternshipDisplayStatus(approvalStatus, startDate, endDate) {
...
export function getInternshipDisplayStatusLabel(status) {
    switch (status) {
        case 'rejected':
            return 'Rejected';
...
export function getInternshipDisplayStatusBadgeClass(status) {
    switch (status) {
        case 'rejected':
